...
import { useHiPawBridge } from './hooks/use-hipaw-bridge';
...
function InfiniteCanvasPage() {
    ...
    useHiPawBridge(projectLoaded, nodes, selectedNodeIds, setNodes, setSelectedNodeIds, setViewport);
    ...
    return (
        <main className="flex h-full min-h-0 overflow-hidden" style={{ background: theme.canvas.background, color: theme.node.text }}>
            ...
            <section className="relative min-w-0 flex-1 overflow-hidden">
                <CanvasTopBar
                    embedded={window.location.pathname.includes('/embed/')}
